  ...
  >
    <div className="flex items-center mb-3">
      ...
      <span className={`text-3xl font-bold ${
        isActive ? 'text-transparent bg-clip-text bg-gradient-to-r from-[#7F1C75] to-[#29146F]' : 'text-gray-400'
      }`}>
        {year}
      </span>
    </div>
    <h3 className={`text-xl font-semibold mb-2 ${isActive ? 'text-gray-800' : 'text-gray-600'}`}>
      {title}
    </h3>
...
const AboutPage = () => {
  ...
  const timelineData = [
    { year: '2010', title: 'KBG IS FOUNDED', description: 'Established in June 2010. Started with just two services- Trademark and ISO Certification Consultancy.' },
    { year: '2015', title: 'Partnership Transformation', description: 'Converted into a partnership firm in 2015. The company was transformed with multiple individuals coming together to jointly own and operate the business.' },
    { year: '2016', title: 'First Branch in Cochin', description: 'A new branch of the company was opened in the city of Cochin.' },
  ...
  const teamMembers = [
    { name: 'Mrs. RINI.R.S', role: 'Founder & Managing Director', phone: '75 9191 9493' },
    { name: 'Mrs. HEMA.V', role: 'Director', phone: '73 5660 9903' },
    { name: 'Mrs. RAJI.S', role: 'Business Support Executive-BSE', expertise: 'Certification Services', phone: '97 479 67367' },
    { name: 'Mrs. RESMY.T', role: 'Customer Care & Accounts', phone: '85 9393 9336' },
    { name: 'Mrs. SUDHEESHA.G.S', role: 'Business Support Executive- BSE', expertise: 'IPR Services', phone: '70 259 27285' },
    { name: 'Ms. ANU.S', role: 'Business Support Executive-BSE', expertise: 'Social Media & Marketing', phone: '98 4646 4141' },
    { name: 'Mr. R. N. IYER', role: 'Mentor, Motivator & Advisor', expertise: 'Certification Services' },
  ...
  const prevTeamSlide = () => {
    setTeamCarouselIndex((prev) => (prev - 3 + teamMembers.length) % teamMembers.length);
  };
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div variants={itemVariants} className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8">Finding Inspiration in Every Turn</p>
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <span className="px-4 py-2 bg-white/20 rounded-full backdrop-blur-sm">ISO 9001 Certified</span>
              <span className="px-4 py-2 bg-white/20 rounded-full backdrop-blur-sm">ISO 14001 Certified</span>
              <span className="px-4 py-2 bg-white/20 rounded-full backdrop-blur-sm">ISO 27001 Certified</span>
              <span className="px-4 py-2 bg-white/20 rounded-full backdrop-blur-sm">Start-up India Recognised</span>
            </div>
          </motion.div>
        </div>
      </motion.section>
