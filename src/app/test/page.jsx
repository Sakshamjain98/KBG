...
export default function FillDocxForm() {
  const [form, setForm] = useState({
    // Trademark fields
    INS_tm_title: 'Mr.',
    INS_tm_full_name: 'John Doe',
    INS_tm_designation: 'Founder',
    INS_tm_company_name: 'TechNova Inc.',
    INS_tm_house_name: 'Sunset Villa',
    INS_tm_location: 'New Delhi',
    INS_tm_landmark: 'Near Metro Station',
    INS_tm_district: 'Central Delhi',
    INS_tm_pincode: '110001',
    INS_tm_state: 'Delhi',
    INS_tm_contact_number: '9876543210',
    INS_tm_email: 'john@example.com',
    INS_tm_date: new Date().toISOString().split('T')[0],
    INS_tm_brand_name: 'NovaBrand',
    INS_tm_class: '35',
    INS_tm_goods_services: 'Software Development',
    INS_tm_additional_goods_services: 'Digital Marketing',
    INS_tm_brand_since: '2020',
    INS_tm_signature_file: '',
    INS_tm_support_doc_file: '',
    // ISO Certification fields
    INS_iso_client_name: 'M/s InnoWorks',
    INS_iso_district: 'Pune',
    INS_iso_state: 'Maharashtra',
    INS_iso_standards: 'ISO 9001, ISO 27001',
    INS_iso_contact_person: 'Jane Smith',
    INS_iso_contact_designation: 'Compliance Officer',
    INS_iso_contact_number: '9123456789',
    INS_iso_contact_email: 'jane@innoworks.com',
    INS_iso_full_address: '123 Corporate Lane, Sector 5, Pune',
    INS_iso_pincode: '411001',
    INS_iso_address_district: 'Pune',
    INS_iso_address_state: 'Maharashtra',
    INS_iso_address_landmark: 'Opposite IT Park',
    INS_iso_org_type: 'Pvt Ltd',
    INS_iso_business_activities: 'Cloud Services, App Development',
    INS_iso_branches: 'Pune, Mumbai, Bangalore',
    INS_iso_total_employees: '120',
    INS_iso_mgmt_level_employees: '5',
    INS_iso_supervisory_employees: '10',
    INS_iso_permanent_employees: '90',
    INS_iso_temp_employees: '15',
    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white p-6">
      <div className="max-w-7xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="bg-orange-600 text-white p-6">
          ...
          <p className="text-orange-100">Fill in all required fields to submit your application</p>
        </div>
