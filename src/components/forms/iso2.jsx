...
export default function IsoForm2() {
  const [form, setForm] = useState({
    ...
    INS_accreditationBody: 'NABCB',
    INS_clientName: 'M/s TechSolutions Pvt Ltd',
    INS_place: 'Bangalore',
    INS_remarks: 'Urgent processing required',
    INS_branch: 'Bangalore South',
    INS_executedBy: 'John Smith',
    INS_officeRef: 'ISO-REF-2023-456',
    INS_isoStandards: ['9001:2015', '27001:2005'],
    INS_contactPerson: 'Rahul Sharma',
    INS_designation: 'Quality Manager',
    INS_mobile: '9876543210',
    INS_landline: '080',
    INS_executionDate: new Date().toISOString().split('T')[0],
    INS_expDate: '2026-05-13',
    INS_firstSurveillance: '2024-05-13',
    INS_secondSurveillance: '2025-05-13',
    INS_orgAddress: 'Tech Park, 5th Floor, Sector 5, HSR Layout, Bangalore - 560102',
    INS_managementType: 'Private Limited',
    INS_businessActivities: 'Software Development, IT Consulting',
    INS_certificationScope: 'Design and development of enterprise software solutions',
    INS_branches: '3 (Bangalore, Pune, Hyderabad)',
    INS_totalEmployees: '150',
    INS_topManagement: '5',
    INS_middleManagement: '15',
    INS_permanentEmployees: '120',
    INS_otherEmployees: '30',
    INS_additionalServices: 'Training, Documentation Support',
    INS_auditDate: '2023-06-15',
    INS_auditTime: '10:00 AM',
    INS_auditor: 'Priya Patel',
    INS_auditorType: 'QCI Registered',
    INS_totalAmount: '75000',
    INS_advanceReceived: '30000',
    INS_chequeNo: 'CHQ456789',
    INS_balance: '45000',
    INS_paymentDate: '2023-05-10',
    INS_bankAt: 'State Bank of India, HSR Branch',
    INS_firstSurveillanceFee: '25000',
